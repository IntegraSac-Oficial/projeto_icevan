 ...
 *
 * Seguindo o padrão shadcn/ui (sem dependência externa).
 * Caminhos SVG baseados em Simple Icons (simpleicons.org).
 *
 * Uso:
...
/* ─── Brand colors map (optional utility) ──────────────────────── */
export const socialBrandColors = {
  whatsapp:  "#25D366",
  instagram: "url(#ig-gradient)",  // uses gradient
  facebook:  "#1877F2",
  youtube:   "#FF0000",
  tiktok:    "#000000",
  linkedin:  "#0A66C2",
...
export type SocialNetwork = keyof typeof socialBrandColors
